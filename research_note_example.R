# released under CC-BY-4.0 by Reynir S. Atlason and Davide Giacalone
...
if(is_positive_integer(nrow(data)/datacheck)==FALSE){stop("number of FR does not match size of dataframe")
  }
